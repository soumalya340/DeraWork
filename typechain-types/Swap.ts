...
export interface Swap extends BaseContract {
  ...
  functions: {
    amountRecieved(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    amountRecieved(overrides?: CallOverrides): Promise<PopulatedTransaction>;
