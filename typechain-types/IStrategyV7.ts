...
export interface IStrategyV7Interface extends utils.Interface {
  contractName: "IStrategyV7";
  functions: {
...
export interface IStrategyV7 extends BaseContract {
  contractName: "IStrategyV7";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IStrategyV7Interface;
